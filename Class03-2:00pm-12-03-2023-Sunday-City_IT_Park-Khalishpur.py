...
#array ---> all programming languages have array but python has list (one kind of array)
...
print(a)                                    #[300, 'a', 'b', 'c', 'd', 'e', 'f']
                ...
                #operator: Operators are arithmetic, logical, and relational.some kinds of sign used to do logical works. 
                # and 
